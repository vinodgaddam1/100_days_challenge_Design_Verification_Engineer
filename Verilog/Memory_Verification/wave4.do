...
add wave -noupdate -expand -group {write signals} -radix hexadecimal /tb/wdata_in
add wave -noupdate -expand -group {write signals} -group {Addr signals} /tb/addr
add wave -noupdate -expand -group {read singals} -radix hexadecimal /tb/rdata_out
